...
\BeginKnitrBlock{Definitions*}
{\label{Def:unnamed-chunk-5}}This is unnumbered in all formats
\EndKnitrBlock{Definitions*}
...
{\label{Tho:unnamed-chunk-6}}Here is a thought.
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio,alt={This is title and a caption with a reference \ref{thm:thm1} inside it}]{./Notes_files/figures/cars-plot-1.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio,alt={More cars things}]{./Notes_files/figures/cars-plot-1.pdf}
