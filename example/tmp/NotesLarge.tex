...
{\iffalse{} (\#Examples:unnamed-chunk-4) \fi{}}You can turn off the colour and padding in html, ePub and Word for any newtheorem or inbuilt theorem type. You do this in the \_bookdown.yml file by adding the theorem name to the colouroff style\_with list.
\EndKnitrBlock{Examples*}
Here is some text which is not part of the above example.

\hypertarget{but-i-want-to-number-some-of-them}{%
\subsection{But I want to number some of them\ldots{}}\label{but-i-want-to-number-some-of-them}}

\BeginKnitrBlock{Definitions*}
{\iffalse{} \label{Def:unnamed-chunk-5} \fi{}}This is unnumbered in all formats
\EndKnitrBlock{Definitions*}
...
\begin{figure}
\centering
\includegraphics{./cars-plot-1.pdf}
...
{\label{exm:unnamed-chunk-6} }Here is an example.

\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=\textheight]{./cars-plot-1.pdf}
...
\BeginKnitrBlock{Example*}
{\iffalse{} (\#\url{Example:unnamed-chunk-7}) \fi{}}An example in which we have autogenerated a useful description of the scatterplot for a person who cannot see it, using BrailleR. To see the content of the long description if you view the HTML in Firefox and right click you can request it.
